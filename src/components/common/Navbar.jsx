...
import logo from "../../assets/Logo/logo12345.png";
                ...
                <li key={index} className="mb-2 md:mb-0">
                  {title === "Catalog" ? (
                        ...
                        (subLinks.length >0) ?(
                          subLinks .map((subLink, i) => (
                            <Link
                              ...
                              className="rounded-lg bg-transparent py-4 pl-4 hover:bg-blue-50"
                              key={i}
                    ...
                    <Link to={path} onClick={closeMobileMenu}>
                      <p className={`${matchRoute(path) ? "text-blue-100 text-lg" : "text-richblack-25"} hover:text-blue-100`}>{title}</p>
                    </Link>
                  )}
                </li>
              ))}
