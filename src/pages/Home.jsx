  ...
  return (
    <div>
      ...
      <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 text-white">
        ...
        {/* Sub Heading */}
        <div className="-mt-3 w-[90%] text-center text-lg font-bold text-richblack-300 italic">
        ...
        {/* Video */}
        <div className="mx-3 my-7 shadow-[20px_-5px_50px_-5px] shadow-blue-400">
          <video
            
            muted
            loop
            autoPlay
            width="1400" // Set your desired width here
